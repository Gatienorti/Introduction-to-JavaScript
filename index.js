...
// firstString = Number(firstString);
...
function hungryDog(a, b){
  ...
  return i;
    ...
    if(a <= 5 ){var i = a * 0.02;}
    else if(a <= 10){var i = a * 0.02;}
    else if(a <= 15){var i = a * 0.02;}
    else {var i = a }
    return a;
  }
  }
...
function game(user, computer){
    ...
    else if ( computer == 'scissors' && user == 'paper') {return "you lose!"}
    else if ( computer == 'paper' && user == 'rock') {return "you lose!"}
    else if ( computer == 'rock' && user == 'scissors') {return "you lose!"}
...
function grade(a){
    if(a < 60) {return "you got a F"}
    else if(a < 70) {return "you got a D"}
    else if(a < 80) {return "you got a C"}
    else if(a < 90) {return "you got a B"}
    else {return "you got a A"}
  }
